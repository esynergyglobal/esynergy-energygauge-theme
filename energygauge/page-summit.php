...
<!-- PRICING CARDS — shown above the comparison so visitors can buy immediately -->
<section class="section section-pricing animate-fade-up" style="padding:24px 24px 16px;">
  <div class="section-inner">
    ...
    <p style="text-align:center;margin-top:28px;font-size:13px;color:var(--gray-600);">
...
<section class="section animate-fade-up" style="padding-top:32px;">
  <div class="section-inner">
    <div class="section-eyebrow">Compare Versions</div>
    <h2 class="section-title">FlaCom vs. Premier</h2>
    <p class="section-subtitle">Not sure which to choose? Premier adds national standards, LEED, and tax deduction capabilities on top of everything in FlaCom.</p>
